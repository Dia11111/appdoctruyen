...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void updateUserInfo() {
        ...
        hashMap.put("userType", "user");//possible values are user, admin: will make admin maunally in firebase realtime db by changing this value
