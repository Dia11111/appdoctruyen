...
import com.example.appdoctruyen.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
    ...
    private void validateData() {
        ...
        else if (TextUtils.isEmpty(seletedCategoryTitle)){
        ...
        storageReference.putFile(pdfUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        uploadPdfInfoDb(uploadedPdfUri, timestamp);
                    }
                })
    ...
    private void uploadPdfInfoDb(String uploadedPdfUrl, long timestamp) {
        ...
        Log.d(TAG, "uploadPdfStorage: Upload Pdf info to firebase db...");
        ...
        hashMap.put("categoryId", ""+seletedCategoryId);
    ...
    private void loadPdfCategories() {
        Log.d(TAG, "loadPdfCatgories: Loading pdf categories...");
    ...
    private String seletedCategoryId, seletedCategoryTitle;
        ...
        builder.setTitle("Pick Category")
                .setItems(categoriesArray, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        seletedCategoryTitle = categoryTitleArrayList.get(which);
                        seletedCategoryId = categoryIdArrayList.get(which);
                        //set to category textview
                        binding.categoryTv.setText(seletedCategoryTitle);

                        Log.d(TAG, "onClick: Selected Category: "+seletedCategoryId+""+seletedCategoryTitle);
                    }
                })
                .show();
    }
