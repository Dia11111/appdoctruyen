...
import com.example.appdoctruyen.databinding.ActivityPdfEditBinding;
...
public class PdfEditActivity extends AppCompatActivity {
        ...
        refBooks.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        //get book info
                        seletedCategoryId = ""+snapshot.child("categoryId").getValue();
                        ...
                        refBookCategory.child(seletedCategoryId)
                                .addListenerForSingleValueEvent(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        //get category
    ...
    private  void validateData(){
        ...
        else if (TextUtils.isEmpty(seletedCategoryId)){
    ...
    private String seletedCategoryId="", selectedCategoryTitle="";
