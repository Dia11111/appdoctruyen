...
import com.example.appdoctruyen.databinding.ActivityProfileEditBinding;
...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setCanceledOnTouchOutside(false);//dont dismiss while clicking outside of progressdialog
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        Intent data = result.getData();// no need here as in camera we already have image in imageUri variable
