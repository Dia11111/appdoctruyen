...
import com.example.appdoctruyen.adapters.AdapterPdfFavorite;
import com.example.appdoctruyen.databinding.ActivityProfileBinding;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    //arraylist to hot hold the books
        ...
        reference.child(firebaseAuth.getUid())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        String formatteDate = MyApplication.formatTimestamp(Long.parseLong(timestamp));
        ...
        ref.child(firebaseAuth.getUid()).child("Favorites")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        binding.favoriteBookCountTv.setText(""+pdfArrayList.size());//cant set int/long to textview so concatnote with string
                        //setup adapter
