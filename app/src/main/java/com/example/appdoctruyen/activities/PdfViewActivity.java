...
import com.example.appdoctruyen.Constants;
import com.example.appdoctruyen.databinding.ActivityPdfViewBinding;
                ...
                .addOnSuccessListener(new OnSuccessListener<byte[]>() {
                    ...
                    public void onSuccess(byte[] bytes) {
                        ...
                        binding.pdfView.fromBytes(bytes)
                                .swipeHorizontal(false)//set false to scroll vertical, set true to load horizontal
