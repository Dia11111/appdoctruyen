...
import static com.example.appdoctruyen.Constants.MAX_BYTES_PDF;
...
//application class runs before your laucher activity
public class MyApplication extends Application {
    ...
    public static void deleteBook(Context context, String bookId, String bookUrl, String bookTitle) {
        ...
        Log.d(TAG, "deleting: Deleting from storage...");
        ...
        storageReference.delete()
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        reference.child(bookId)
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {
                                        Log.d(TAG, "onSuccess: Deleted from db to");
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Log.d(TAG, "onFailure: Failed to detele from db due to" + e.getMessage());
                                        progressDialog.dismiss();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Log.d(TAG, "onFailure: Failed to detele from storage due to " + e.getMessage());
                        progressDialog.dismiss();
                        Toast.makeText(context, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
                        ...
                        pdfView.fromBytes(bytes)
                                ...
                                .onLoad(new OnLoadCompleteListener() {
                                    ...
                                    public void loadComplete(int nbPages) {
                                        ...
                                        if (pagesTv !=null){
                                            pagesTv.setText(""+nbPages);//concatnate with double quotes because cant set init in textview
                                        }
                                    }
                                })
                                .load();
        ...
        ref.child(bookId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //in case of null replace witn 0
    ...
    public static void downloadBook(Context context, String bookId, String bookTitle, String bookUrl) {
        ...
        ProgressDialog progressDialog = new ProgressDialog(context);
        progressDialog.setTitle("Please wait");
        progressDialog.setMessage("Downloading" + nameWithExtension + "..."); //Downloading name_book.pdf
