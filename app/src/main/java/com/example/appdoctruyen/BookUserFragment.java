...
import com.example.appdoctruyen.adapters.AdapterPdfUser;
import com.example.appdoctruyen.databinding.FragmentBookUserBinding;
...
public class BookUserFragment extends Fragment {
    ...
    private void loadMostViewedDownloadedBooks(String orderBy) {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Books");
        ref.orderByChild(orderBy).limitToLast(10)//load 10 most view or download book
    ...
    private  void loadCategoriezedBooks(){
        //init list
        pdfArrayList = new ArrayList<>();
